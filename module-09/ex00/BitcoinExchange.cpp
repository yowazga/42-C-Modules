...
/*   Updated: 2023/11/23 22:30:28 by yowazga          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::count(line.begin(), line.end(), sep) != 1 ? throw std::string("Bad input => " + line) : 0;
	std::istringstream pars(line);
	std::string date, value;
	std::getline(pars, date, sep);
	std::getline(pars, value, sep);
