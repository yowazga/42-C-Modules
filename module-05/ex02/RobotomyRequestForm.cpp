...
/*   Updated: 2023/10/15 14:20:06 by yowazga          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "RobotomyRequestForm.hpp"

RobotomyRequestForm::RobotomyRequestForm() : AForm("Robotom form", 72, 45), target("unspecified"){}
...
void RobotomyRequestForm::execute(Bureaucrat const & executor) const
{
	...
	else
	{
		...
		if (rand() % 2 == 0)
			std::cout << "Rotomization was successfull." << std::endl;
		else
